<template>
     ...
     <div class="container">
        <!-- <div> -->
         ...
         <div class="row">
             <div class="col-lg-6 col-xl-6">
                <!-- <div class="justify-center" style="padding-left:120px;padding-right:80px"> -->
                    <div>
                     ...
                     <h1 class="h3-large">Simplify your hiring process, avoid costly mis-hires</h1>
             ...
             <div class="col-lg-6" v-if="vanish == true">
      ...
      >
        ...
        <div>
          <q-btn class="text-grey-1 full-width" label="Login" aria-label="bold" type="submit" style="background-color:#28534E" rounded/><br/><br/>
          ...
          <!-- <q-btn label="Register" @click="toggle" to="/register" color="primary" /> -->
            ...
            <q-tab-panel name="register" class="tabpanel">
              <q-form v-if="registertab == true" class="q-px-sm q-pt-xl" @submit.prevent="registerform">
                <q-input 
                         ref="email"
                         square 
                         clearable 
          ...
          <q-btn class="text-grey-1 full-width" label="Register" aria-label="bold" type="submit" style="background-color:#28534E;" rounded/><br/><br/>
          
        </div>
              </q-form>
  
              <q-form v-else @submit.prevent="verifyotp">
                  <p>Enter the OTP sent to your Registered Mail id</p>
                  <q-input label="OTP" v-model="otp" style="padding-bottom:15px"/>
                  <q-btn class="text-grey-1 full-width" label="Verify" aria-label="bold" type="submit" style="background-color:#28534E;" rounded/><br/><br/>
              </q-form>
            </q-tab-panel>
   ...
   <div id="features" class="cards-1 accordion-3">
       <div class="container">
           <div class="row">
             <div class="col-xl-12">
                 <h2 class="h2-heading" style="padding-top: 20px;">We've got a pricing plan that's perfect for you!</h2>
         ...
         //console.log('error')
          ...
          api
            ...
            .then(async (res) => {
               ...
               api .post(`api/category/list`,{companyId : admin.value.id},
        {
          headers: {
